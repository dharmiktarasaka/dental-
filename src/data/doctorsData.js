export const doctorsData = [
  {
    slug: "dr-aarav-patel",
    name: "Dr. Aarav Patel",
    title: "Dr. Aarav Patel - Implantologist & Prosthodontist in Ahmedabad",
    ...
    achievements: [
      ...
      "Best Dentist Award - Gujarat Dental Conference 2023",
      "Life Member of Indian Prosthodontic Society (IPS)"
    ],
    schedule: "Mon - Sat: 9:00 AM - 1:00 PM & 4:00 PM - 8:00 PM",
    services: [
      "Guided Single & Multiple Implants",
      "All-on-4 & All-on-6 Implant Systems",
      "Full Mouth Denture Rehabilitation",
      "Zirconia Crown and Veneer Bonding"
    ]
  },
  {
    slug: "dr-ananya-sharma",
    name: "Dr. Ananya Sharma",
    title: "Dr. Ananya Sharma - Root Canal Specialist in Ahmedabad",
    ...
    achievements: [
      ...
      "Published Author in International Journal of Endodontics",
      "Specialist in Laser-assisted Painless Root Canals"
    ],
    schedule: "Mon - Sat: 10:00 AM - 2:00 PM & 5:00 PM - 8:30 PM",
    services: [
      "Microscope-enhanced Root Canal Treatment",
      "Teeth Whitening and Bleaching",
      "Porcelain Veneers and Dental Bonding",
      "Conservative Restorations and Inlays"
    ]
  },
  {
    slug: "dr-rohan-mehta",
    name: "Dr. Rohan Mehta",
    title: "Dr. Rohan Mehta - Orthodontist & Aligner Specialist in Ahmedabad",
    ...
    achievements: [
      ...
      "Active Member of Indian Orthodontic Society (IOS)",
      "Expertise in interceptive pediatric orthodontics"
    ],
    schedule: "Mon - Sat: 11:00 AM - 1:00 PM & 4:30 PM - 7:30 PM",
    services: [
      "Invisalign & Clear Invisible Aligners",
      "Ceramic & Metal Braces",
      "Pediatric Orthodontic Space Maintainers",
      "Surgical Orthodontic Jaw Corrections"
    ]
  }
];
